                ...
                <div className="flex flex-1 flex-col bg-[oklch(0.982_0.005_85)]">
                    ...
                    <div className="flex flex-1 flex-col items-center justify-center px-8 py-12">
                        <div className="w-full max-w-sm">
                            <div className="mb-8">
                                <h1 className="text-2xl font-bold text-[oklch(0.16_0.025_258)]">Forgot your password?</h1>
                            ...
                            <p className="mt-6 text-center text-sm text-slate-500">
                                <TextLink href={route('login')} className="font-semibold text-[oklch(0.36_0.11_258)] hover:text-[oklch(0.30_0.09_258)]" tabIndex={3}>
                                    ← Back to sign in
                                </TextLink>
                            </p>
                        </div>
