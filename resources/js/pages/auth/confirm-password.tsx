                ...
                <div className="flex flex-1 flex-col bg-[oklch(0.982_0.005_85)]">
                    ...
                    <div className="flex flex-1 flex-col items-center justify-center px-8 py-12">
                        <div className="w-full max-w-sm">
                            <div className="mb-8">
                                <h1 className="text-2xl font-bold text-[oklch(0.16_0.025_258)]">Confirm your password</h1>
                                <p className="mt-1.5 text-sm text-slate-500">
                                    This is a protected area. Please re-enter your password before continuing.
                                </p>
                            </div>
