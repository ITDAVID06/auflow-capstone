...
export default function ChangePasswordPage() {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('auth.change-password.update'), { onFinish: () => reset('password', 'password_confirmation') });
    };
                ...
                <div className="flex flex-1 flex-col bg-[oklch(0.982_0.005_85)]">
                    ...
                    <div className="flex flex-1 flex-col items-center justify-center px-8 py-12">
                        <div className="w-full max-w-sm">
                            <div className="mb-8">
                                <h1 className="text-2xl font-bold text-[oklch(0.16_0.025_258)]">Set a new password</h1>
